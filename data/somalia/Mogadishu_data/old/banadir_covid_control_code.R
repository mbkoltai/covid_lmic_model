...
# dim(x1): (8,3) | dim(cemeteries): 6,7 | dim(x2): 1730,22
#.........................................................................................      
...
# ggplot(x1[x1$date>as.Date("2019-06-21"),],aes(x=date,y=graves_best)) + facet_wrap(~cemetery,scales = "free") +
#   geom_line() + geom_point() + theme_bw() + scale_x_date(date_breaks = "2 weeks") + theme(axis.text.x = element_text(size=7,angle=90)) +
#   ggtitle("new burials (graves_best)") # ggsave("burials_over_time_monocol.png", width=27, height=18, units = "cm", dpi = "print")
...
# dim(x3): 12,3
    ...
    # Draw plot
      ...
      # write_csv(x1,"burial_rate_over_time.csv")
...
#.........................................................................................                            
### Estimating excess area increase

source("banadir_covid_excess_area.R")
